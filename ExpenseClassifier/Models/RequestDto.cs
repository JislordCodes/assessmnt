...
{
    /// <summary>Caller supplied line-item id (batch requests only).</summary>
...
public class BatchSummary
{
    ...
    /// <summary>Items classified but without enough information (e.g. no amount) to verify limits.</summary>
    public int UnverifiableCount { get; set; }

    /// <summary>Items that could not be classified at all (upstream failure); the batch still succeeds.</summary>
